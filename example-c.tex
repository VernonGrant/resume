...
\begin{tikzpicture}[fill=white]
  ...
  %% Contact details
  \draw[fill=white,pattern=grid, pattern color=black!5] (13,3) rectangle (18,2) node[pos=.5] {vernon@ruppell.io};
  \draw[fill=white,pattern=grid, pattern color=black!5] (13,2) rectangle (18,1) node[pos=.5] {+270 0000 0000};
  \draw[fill=white,pattern=grid, pattern color=black!5] (13,1) rectangle (18,0) node[pos=.5] {Cape Town, South Africa};
\end{tikzpicture}
